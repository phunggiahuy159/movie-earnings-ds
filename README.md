...
│
├── dataset/
│   ├── data_joined.csv              # Raw IMDb data (26+ movies)
│   └── data_cleaned.csv             # Cleaned data (generated by pipeline)
│
├── models/
│   └── box_office_model.pkl         # Trained Random Forest model (generated)
│
├── demo/
│   └── plots/                       # EDA visualizations (generated)
│       ├── gross_distribution.png
│       ├── budget_vs_gross.png
│       ├── genre_analysis.png
│       ├── rating_analysis.png
...
└── src/
    ...
    ├── eda_visualizations.py        # EDA plots generation
    ├── gradio_app.py                # Interactive web interface
    ├── join_data.py                 # Data joining utility
    └── crawler/                     # IMDb web scraper
        ├── run_full_crawl.sh        # Crawler script
        └── imdbCrawler/             # Scrapy spider
```
